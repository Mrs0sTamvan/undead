...
def menu():
    os.system("cowsay -f ghostbusters Undead ")
    print("""
              |  |         |                |
              |  |  \   _` |  -_)  _` |  _` |
             \__/_| _|\__,_|\___|\__,_|\__,_|
Note : lu pilih nomor 00 dulu sebelum yg lain okey
::::::::::::::::::::(Undead Slayer):::::::::::::
...
while loop:
    ...
    if what == "00":
        print("================================")
        print("Gua Mohon Sama Yang Pakai Tools Ini Harap Tobat:)")
        print("----------------")
        hm = input("[?] Mo di lanjutin kaga nih cuk? (y/n): ")
        print("================================")
        if hm == "y": 
            print("========================================================")
            print("Hati-hati yah anak² sekarang musim penculikan...")
            print("ntar lu di culik bencong lagi :(.")
            print("========================================================")
            ...
            os.system("clear")
            print("========================================")
            print("[+] Done install, very good ea")
            print("[+] Silahkan mamank hekel")
            print("========================================")
        else:
